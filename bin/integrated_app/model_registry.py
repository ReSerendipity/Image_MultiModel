...
from .engine_interface import InMemoryEngineRegistry, get_registry
...
class ModelRegistry:
    ...
    def get_engine_config(self, name: str) -> Optional[Dict[str, Any]]:
        return self._registry._configs.get(name)


# ── 全局单例 ──────────────────────────────────────────────────
_global_registry_bridge: Optional[ModelRegistry] = None
