...
) else if exist "C:\Users\Doro\Seedvr2\WPy64-312101\python\python.exe" (
    set WPY_EXE=C:\Users\Doro\Seedvr2\WPy64-312101\python\python.exe
) else (
