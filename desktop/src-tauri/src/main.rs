                ...
                if st.failed > 0 {
                    ...
                    crate::notification::handle_show_notification(
                        ...
                        crate::notification::ShowNotification {
                            title: "Image MultiModel 安全告警".to_string(),
                            body: format!(
...
/// 初始化日志：日志文件落在 logs\imgmulti-shell.log，RUST_LOG 可覆盖级别（debug/trace/warn/error）
fn init_logging() {
