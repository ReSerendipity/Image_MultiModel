...
//!   存储于 `%APPDATA%/ImageMultiModel/window_state.json`（见 [`crate::config::WindowState`]）。
...
/// 空闲标题
pub const IDLE_TITLE: &str = "Image MultiModel";
/// 处理中标题
pub const BUSY_TITLE: &str = "Image MultiModel - 处理中...";
...
mod tests {
    ...
    #[test]
    fn title_constants() {
        assert_eq!(IDLE_TITLE, "Image MultiModel");
        assert_eq!(BUSY_TITLE, "Image MultiModel - 处理中...");
    }
